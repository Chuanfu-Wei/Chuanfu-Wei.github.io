...
window.onload = function () {
  ...
  function showTime() {
    ...
    mydiv.style.cssText = 'color:red;font: bold 18px/20px "楷体";margin: 30px auto;display: block;width: 200px;height: 50px;text-align: center;';
